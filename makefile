...
bitcode:
	...
	$(CXX) $(EMOPTS) $(INCLUDES) $(DEFINES) -c -o $(TMPDIR)/glue.bc glue.cpp

library: bitcode
	@mkdir -p bin
	$(CXX) $(LINK_OPTS) $(INCLUDES) $(DEFINES) $(EMOPTS) -o $(OUTDIR)/bgfx_$(BUILD).js $(TMPDIR)/glue.bc $(TMPDIR)/bgfx_$(BUILD).bc
